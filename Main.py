...
ctypes.windll.kernel32.SetConsoleTitleW(f'[XD-SELFBOT v{SELFBOT.__version__}] | Loading...')
...
def startprint():
    ...
    print(f'''{Fore.BLUE}    
                       ...
                       {Fore.CYAN}XD-SELFBOT {SELFBOT.__version__} | {Fore.GREEN}Logged in as: {Alucard.user.name}#{Alucard.user.discriminator} {Fore.CYAN}| ID: {Fore.GREEN}{Alucard.user.id}   
                       ...
                       {Fore.CYAN}By !D.T|Zack!ß§ ❄Boss❄#3135 
    '''+Fore.RESET)
...
def Init():
    if config.get('token') == "token-here":
        ...
        try:
            ...
            os.system(f'title (XD-SELFBOT) - Version {SELFBOT.__version__}')
...
async def on_connect():
    ...
    startprint()
    ctypes.windll.kernel32.SetConsoleTitleW(f'[XD-SELFBOT v{SELFBOT.__version__}] | Logged in as {Alucard.user.name}')
...
async def help(ctx):
    await ctx.message.delete()
    embed=discord.Embed(title="Selfbot commands", url="https://cdn.discordapp.com/attachments/726206353944608849/731912933839470663/Avatar.png", description="**{Page 1}**", color=0x00ffee)
    embed.set_author(name="!D.T|Zack!ß§ ❄Boss❄#3135", url="https://cdn.discordapp.com/attachments/726206353944608849/731912933839470663/Avatar.png", icon_url="https://cdn.discordapp.com/attachments/726206353944608849/731912933839470663/Avatar.png")
    embed.set_thumbnail(url="https://cdn.discordapp.com/attachments/726206353944608849/731912933839470663/Avatar.png")
    embed.add_field(name="help", value="Displays this help menu", inline=False)
    embed.add_field(name="av (@user)", value="Displays the profile picture of the mentioned user", inline=False)
    embed.add_field(name="revav (@user)", value="Reverse avatar the mentioned user profile picture", inline=False)
    embed.add_field(name="whois (@user)", value="Displays discord information of the mentioned user", inline=False)
    embed.add_field(name="role-hexcode (@role)", value="Displays the hexcode of the specified role", inline=False)
    embed.add_field(name="guildicon", value="Display guild icon", inline=False)
    embed.add_field(name="roleinfo (@role)", value="Display some info about the specified role", inline=False)
    ...
    embed.add_field(name="dm (@user) (message)", value="Sends a message to the specified user", inline=False)
    ...
    embed.add_field(name="secret (message)", value="Returns the message but hidden ||hidden||", inline=False)
    embed.add_field(name="bold (message)", value="Returns the message but **bold**", inline=False)
    embed.add_field(name="unflip", value="Sends: ┬─┬ ノ( ゜-゜ノ)", inline=False)
    embed.add_field(name="tableflip", value="Sends: (╯°□°）╯︵ ┻━┻", inline=False)
    embed.add_field(name="lenny", value="Sends: ( ͡° ͜ʖ ͡°)", inline=False)
    embed.add_field(name="shrug", value="Sends: ¯\_(ツ)_/¯", inline=False)
    embed.add_field(name="reverse (message)", value="Reverses ur message", inline=False)
    embed.add_field(name="ascii (message)", value="Makes your message ascii/fancy", inline=False)
    ...
    embed.add_field(name="purge (amount)", value="Deletes your messages based on the amount you specify", inline=False)
...
async def help2(ctx):
    await ctx.message.delete()
    embed=discord.Embed(title="Selfbot commands", url="https://cdn.discordapp.com/attachments/726206353944608849/731912933839470663/Avatar.png", description="**{Page 2}**", color=0x00ffee)
    embed.set_author(name="!D.T|Zack!ß§ ❄Boss❄#3135", url="https://cdn.discordapp.com/attachments/726206353944608849/731912933839470663/Avatar.png", icon_url="https://cdn.discordapp.com/attachments/726206353944608849/731912933839470663/Avatar.png")
    embed.add_field(name="hastebin (message)", value="Saves your text/code to hastebin", inline=False)
    ...
    embed.add_field(name="insult", value="Sends insult like abc", inline=False)
    embed.add_field(name="devowel (message)", value="Devowels your message", inline=False)
    embed.add_field(name="1337-speak (message)", value="Translates your message to 1337 language", inline=False)
    embed.add_field(name="combine (name1) (name2)", value="Combines the two names together", inline=False)
    embed.add_field(name="pingweb (website)", value="Pings a website in order to check if its working or not (ie: !pingweb https://google.com)", inline=False)
    ...
    embed.add_field(name="tts (message)", value="Send that message in .wav format, like an audio", inline=False)
    embed.add_field(name="upper (message)", value="Make your message CAPS", inline=False)
    embed.add_field(name="lmgtfy (message)", value="Use lmgtfy search engine to look-up something", inline=False)
...
async def help3(ctx):
    await ctx.message.delete()
    embed=discord.Embed(title="Selfbot commands", url="https://cdn.discordapp.com/attachments/726206353944608849/731912933839470663/Avatar.png", description="**{Page 3}**", color=0x00ffee)
    embed.set_author(name="!D.T|Zack!ß§ ❄Boss❄#3135", url="https://cdn.discordapp.com/attachments/726206353944608849/731912933839470663/Avatar.png", icon_url="https://cdn.discordapp.com/attachments/726206353944608849/731912933839470663/Avatar.png")
    embed.add_field(name="lesbian", value="Random lesbian [Anime]", inline=False)
    embed.add_field(name="lewdjeko", value="Random lewd neko [Anime]", inline=False)
    embed.add_field(name="blowjob", value="Random blowjob [Anime]", inline=False)
    embed.add_field(name="tits", value="Random tits [Anime]", inline=False)
    embed.add_field(name="boobs", value="Random boobs [Anime]", inline=False)
    embed.add_field(name="hentai", value="Random hentai [Anime]", inline=False)
    embed.add_field(name="feet", value="Random feet [Anime]", inline=False)
    embed.add_field(name="erofeet", value="Random erotic feet [Anime]", inline=False)
    embed.add_field(name="anal", value="Random anal [Anime]", inline=False)
    await ctx.send(embed=embed, delete_after=7.0)
    
@Alucard.command()
async def help4(ctx):
    await ctx.message.delete()
    embed=discord.Embed(title="Selfbot commands", url="https://cdn.discordapp.com/attachments/726206353944608849/731912933839470663/Avatar.png", description="**{Page 4}**", color=0x00ffee)
    embed.set_author(name="!D.T|Zack!ß§ ❄Boss❄#3135", url="https://cdn.discordapp.com/attachments/726206353944608849/731912933839470663/Avatar.png", icon_url="https://cdn.discordapp.com/attachments/726206353944608849/731912933839470663/Avatar.png")    
    embed.add_field(name="set-pfp (url)", value="Set the specified url as profile picture [Must have password set in config.json file]", inline=False)
    embed.add_field(name="btcstream", value="Stream current btc price", inline=False)
    embed.add_field(name="pfpsteal (@user)", value="Allows you to steal mentioned user profile picture [Must have password set in config.json file]", inline=False)
    embed.add_field(name="blank", value="Turns your name and profile picture blank", inline=False)
    embed.add_field(name="hypesquad (house)", value="Allows you to change your hypesquad (ie: !hypesquad bravery)", inline=False)
    embed.add_field(name="fakenet (type) [name]", value="Allows you to spoof connections in your profile (ie: !fakenet skype Alucard)", inline=False)
    embed.add_field(name="steal-all-pfp", value="Steal all the pfps in the server", inline=False)
    embed.add_field(name="stream (message)", value="Stream that message in your profile", inline=False)
    embed.add_field(name="watching (message)", value="Add a watching status with that message in your profile", inline=False)
    embed.add_field(name="listening (message)	", value="Add a listening status with that message in your profile", inline=False)
    embed.add_field(name="game (message)", value="Add a game status with that message in your profile", inline=False)
    embed.add_field(name="masscon (type) (amount) (name)", value="Add a big amount of connections to your profile (ie: !masscon skype 5 ALUCARD", inline=False)
    await ctx.send(embed=embed, delete_after=7.0)

@Alucard.command()
async def help5(ctx):
    await ctx.message.delete()
    embed=discord.Embed(title="Selfbot commands", url="https://cdn.discordapp.com/attachments/726206353944608849/731912933839470663/Avatar.png", description="**{Page 5}**", color=0x00ffee)
    embed.set_author(name="!D.T|Zack!ß§ ❄Boss❄#3135", url="https://cdn.discordapp.com/attachments/726206353944608849/731912933839470663/Avatar.png", icon_url="https://cdn.discordapp.com/attachments/726206353944608849/731912933839470663/Avatar.png")
    embed.add_field(name="fox", value="Random fox image", inline=False)
    embed.add_field(name="dog", value="Random dog image", inline=False)
    embed.add_field(name="cat", value="Random cat image (api required config)", inline=False)
    embed.add_field(name="minesweeper", value="play minesweeper in chat ", inline=False)
    embed.add_field(name="dick (@user)", value="dick size of user", inline=False)
    embed.add_field(name="r (@role)", value="rainbow role xd", inline=False)
    embed.add_field(name="8ball (question)", value="Answers your question", inline=False)
    ...
    embed.add_field(name="feed (user)", value="Feed the mentioned user", inline=False)
    embed.add_field(name="tickle (user)", value="Tickle the mentioned user", inline=False)
    embed.add_field(name="slap (user)", value="Slap the mentioned user", inline=False)
    embed.add_field(name="hug (user)", value="Hug the mentioned user", inline=False)
    embed.add_field(name="smug (user)", value="Smug at the mentioned user", inline=False)
    embed.add_field(name="pat (user)", value="Pat the mentioned user", inline=False)
...
async def help6(ctx):
    await ctx.message.delete()
    embed=discord.Embed(title="Selfbot commands", url="https://cdn.discordapp.com/attachments/726206353944608849/731912933839470663/Avatar.png", description="**{Page 6}**", color=0x00ffee)
    embed.set_author(name="!D.T|Zack!ß§ ❄Boss❄#3135", url="https://cdn.discordapp.com/attachments/726206353944608849/731912933839470663/Avatar.png", icon_url="https://cdn.discordapp.com/attachments/726206353944608849/731912933839470663/Avatar.png")
    embed.add_field(name="tokeninfo (token)", value="Display various information about the token", inline=False)
    embed.add_field(name="tokenfuck (token)", value="Crash, glitch screen of a token, all in discord", inline=False)
    embed.add_field(name="geoip (ip)", value="Display various information about the IP", inline=False)
    embed.add_field(name="ebay-view (url) (views)", value="Send views to a ebay product (ie: !ebay-view https://www.ebay.es/itm/XXXXXX 100", inline=False)
    embed.add_field(name="gmail-bomb", value="mail bomb xd", inline=False)
    embed.add_field(name="nitro", value="gen nitro", inline=False)
    embed.add_field(name="proxies", value="Scraps HTTP/HTTPS/SOCKS4/SOCKS5 proxies", inline=False)
    embed.add_field(name="address (text)", value="Generates fake address based on the text you specify", inline=False)
    embed.add_field(name="masslogin (choice)", value="Allows you to mass-login in bot/user tokens [Choices can be: user and bot]", inline=False)
    await ctx.send(embed=embed, delete_after=7.0)
    
@Alucard.command()
async def help7(ctx):
    await ctx.message.delete()
    embed=discord.Embed(title="Selfbot commands", url="https://cdn.discordapp.com/attachments/726206353944608849/731912933839470663/Avatar.png", description="**{Page 7}**", color=0x00ffee)
    embed.set_author(name="!D.T|Zack!ß§ ❄Boss❄#3135", url="https://cdn.discordapp.com/attachments/726206353944608849/731912933839470663/Avatar.png", icon_url="https://cdn.discordapp.com/attachments/726206353944608849/731912933839470663/Avatar.png")
    ...
    embed.add_field(name="encode (string)", value="Encode a string to base64 ascii", inline=False)
    embed.add_field(name="decode (string)", value="Decode a string from base64 to regular text", inline=False)
    embed.add_field(name="bitly (link)", value="Shorten ur link using bitly [Must have bitly api key set in config.json file]", inline=False)
    embed.add_field(name="tinyurl (link)", value="Shorten ur link using tinyurl", inline=False)
    embed.add_field(name="weather (city)", value="Lookup weather for the specified city", inline=False)
    embed.add_field(name="backup-f", value="Backup your friends name and discrim", inline=False)
    embed.add_field(name="auto-bump (channel id)", value="Automatically bump server to disboard.org [Needs the Disboard to be in the server]", inline=False)
    embed.add_field(name="mac (mac)", value="Lookup a bit of info about a MAC (ie: !mac xx:xx:xx:xx:xx:xx)", inline=False)
    embed.add_field(name="copy", value="clone server", inline=False)
    embed.add_field(name="destroy", value="Ban, delete roles, delete channels, edit guild info, mass create channels All in one!", inline=False)
    embed.add_field(name="dmall (messsage)", value="Messages every user in that guild with a sleep time of 10 seconds for every user [Might get you disabled]", inline=False)
    embed.add_field(name="massban", value="Ban all the users in that guild", inline=False)
    embed.add_field(name="masskick", value="Kick all the users in that guild", inline=False)
...
@Alucard.command()
async def insult(ctx): # b'\xfc'
    await ctx.message.delete()
    ABC = ['Fuck', 'you!', 'go', 'to', 'hell', 'if', 'you', 'dont', '1', 'will', 'fuck', 'you', 'up', 'now', 'i', 'know', 'my', 'swears', 'you', 'will', 'go', 'to', 'hell', 'welcome', 'to', 'hell', 'fuckhead']
    message = await ctx.send(ABC[1])
    for _next in ABC[1:]:
        await message.edit(content=_next)
        await asyncio.sleep(1)
...
async def embed(ctx): 
    await ctx.message.delete()
    messageAuthor=ctx.message.content.split(" ")
    messageAuthor.pop(0)
    embedVar=discord.Embed(title=" ", description=" ".join(messageAuthor), color=0x00ffee)
    await ctx.message.channel.send(embed=embedVar)

@Alucard.command(aliases=['rainbow-role2'])
async def r2(ctx, *, role): # b'\xfc'
    await ctx.message.delete()
    role = discord.utils.get(ctx.guild.roles, name=role)
    while True:
        try:
...
@Alucard.command(aliases=['rainbow-role3'])
async def r3(ctx, *, role): # b'\xfc'
    await ctx.message.delete()
    role = discord.utils.get(ctx.guild.roles, name=role)
    while True:
        try:
...
@Alucard.command(aliases=['rr', 'RR'])
async def russianroulette(ctx):
    deadlive = ['has died', 'has lived', 'has lived', 'has lived']

    await ctx.send(f"{ctx.author.mention} {random.choice(deadlive)}")  
    
@Alucard.command(aliases=['rainbow-role4'])
async def r4(ctx, *, role): # b'\xfc'
    await ctx.message.delete()
    role = discord.utils.get(ctx.guild.roles, name=role)
    while True:
        try:
